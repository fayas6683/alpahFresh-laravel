...
class User extends Model implements UserInterface,BillableInterface,FriendableInterface,RemindableInterface {
    use BillableTrait;
    use RemindableTrait;
	/**
	 ...
	 * @var array
	 */
    /**need to add all methods additional from models/User**/
    ...
    public function pledgeTier(){
        return $this->belongsToMany('PledgeTiers');
    }
	...
	{
		return $this->hasPermission('GlobalAdmin');
	}
	/**
