    ...
    'grant_types' => [
        'password' => [
            ...
            'callback' => function($username, $password) {
                    ...
                    $throttle       = Sentry::findThrottlerByUserId(Sentry::findUserByCredentials($credentials)->id);
                    ...
                    // $superAdmin = Sentry::findGroupByName('GlobalAdmin');
                    ...
                    //     return false;
                    // }
                    // elseif(!$user->subscribed() && (!$user->inGroup($superAdmin))){
